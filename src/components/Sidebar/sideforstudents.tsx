...
import i111 from '../../images/country/111.svg';

import i113 from '../../images/country/113.svg';
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to={`/dashboard/student/settings/${profileData}`}
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              <li>
                <NavLink
                  to={`/dashboard/student/profile/${profileData}`}
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('profile') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <img src={i113} alt="home icon" width="18" height="18" />
                  Profile
                </NavLink>
              </li>
            </ul>
