        ...
        <div className="mt-5 text-left">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center mt-5">
            <NavLink
              ...
              className="flex items-center inline-block text-base sm:text-lg bg-blue-700 px-6 sm:px-8 py-2 text-white rounded hover:bg-blue-500 transition duration-300 sm:mb-0"
            >
              <span className="me-2">
                <TiArrowBack />
              </span>
