...
function GetGroupsForHomeworkTeacher() {
  ...
  return (
    <DefaultLayoutTeacher>
      <div className="text-2xl text-center uppercase font-bold dark:text-white">
        Select one group to see your homeworks
      </div>
      <div className="">
            ...
            {courses && courses ? (
              courses.map((product: any) => (
                <NavLink
                  ...
                  to={`/dashboard/teacher/my/all/homeworks/${product.group_id}`}
...
export default GetGroupsForHomeworkTeacher;
