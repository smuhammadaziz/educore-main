...
function OneCourseInfoPageSodiqAcademy() {
  ...
  return (
    <DefaultLayoutSodiqAcademy>
      <div className="px-10 bg-slate-100 max-w-screen-xl mx-auto py-10 flex flex-col lg:flex-row justify-between items-center">
        <div>
...
export default OneCourseInfoPageSodiqAcademy;
